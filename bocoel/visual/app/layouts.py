...
from dash.dcc import Graph, Slider, Dropdown, Checklist, Markdown
from dash.html import H1, H2, H3, B, Div, Img, P, Ul, Li, Pre
                    ...
                    Div(
                        children= [
                            Div(style = {'display' : 'flex'},
                                children=
                                    [Div(children=[H3("Select Models:",style={"border-bottom":"0.5px lightcyan solid",
                                                                              "margin-left": "5px"}),
                                                   Checklist(
                                        ["GPT-3","BERT"],
                                        ['GPT-3'],
                                        ...
                                        style={
                                            ...
                                            style={"background-color": constants.BLOCK_COLOR,
                                                    "color": constants.FONT_COLOR,
                                                    "border-right":"0.5px lightcyan solid"
                                                    }),

                                        Div(children=[H3("Select Corpus:",style={"border-bottom":"0.5px lightcyan solid",
                                                                                     "margin-left": "5px"}),
                                                      Checklist(
                                        ["Corpus-1","Corpus-2"],
                                        ["Corpus-1"],
